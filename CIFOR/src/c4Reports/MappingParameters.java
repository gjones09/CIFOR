...
public class MappingParameters extends javax.swing.JDialog {
    ...
    private void processSection() {
        ...
        labelCounty			= new javax.swing.JLabel();
        ...
        inputCounty			= new javax.swing.JTextField();

        FormListener formListener = new FormListener();
        KeyListener keyListener = null;

        setTitle(c4Utilities.CIFORProperties.mParameterTitle);
        setLocation(300,200);
        ...
        labelOrganism.setText(c4Utilities.CIFORProperties.mParameterOrganism);
        labelPrimaryEnzyme.setText(c4Utilities.CIFORProperties.mParameterPrimaryEnzyme);
        labelSecondaryEnzyme.setText(c4Utilities.CIFORProperties.mParameterSecondaryEnzyme);
        labelOtherResult.setText(c4Utilities.CIFORProperties.mParameterOtherResult);
        labelState.setText(c4Utilities.CIFORProperties.mParameterState);
        labelCounty.setText(c4Utilities.CIFORProperties.mParameterCounty);
        ...
        labelHeader.setText(c4Utilities.CIFORProperties.mParameterHeading);
        ...
        inputState.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        inputCounty.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelCounty)
                    .addComponent(inputCounty, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(18, 18, 18)
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == okButton) {
                MappingParameters.this.okButtonActionPerformed(evt);
            }
            else if (evt.getSource() == cancelButton) {
                MappingParameters.this.cancelButtonActionPerformed(evt);
            }
            else if (evt.getSource() == helpButton) {
                MappingParameters.this.helpButtonActionPerformed(evt);
            }
        }
    }                       
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {                                         
		...
		stringState				= inputState.getText();						// get the OtherResult (with wildcards)
		stringState		 		= stringState.replace('*', '%');			// substitute the * wildcard with % for SQL LIKE statement

		stringCounty			= inputCounty.getText();					// get the OtherResult (with wildcards)
		stringCounty	 		= stringCounty.replace('*', '%');			// substitute the * wildcard with % for SQL LIKE statement
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
            	...
            	MappingParameters frame = new MappingParameters();
	    ...
	    private javax.swing.JLabel labelCounty;
	    ...
	    public javax.swing.JTextField inputState;
	    public javax.swing.JTextField inputCounty;
	    ...
	    public static String stringCounty;
