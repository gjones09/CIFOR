...
public class FrequencyReportParameters extends javax.swing.JDialog implements ItemListener {
	...
	public FrequencyReportParameters() {
        ...
        setTitle(c4Utilities.CIFORProperties.fParameterTitle);
        setLocation(300,200);
        ...
        ckboxAllReports.setMnemonic(KeyEvent.VK_A); 
        ckboxAllReports.setSelected(true);

        ckboxAllReports.addItemListener(this);
		...
		inputCurrentDate.setEnabled(false);
	...
	public void itemStateChanged(ItemEvent e)
		{
	        if (ckboxAllReports.isSelected())
        		...
        		{    
        			inputCurrentDate.setEnabled(true);
        			processSection();
        		}
		}
    
    private class FormListener<ckboxAllReports> implements java.awt.event.ActionListener {
        FormListener() {}
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == okButton) {
                FrequencyReportParameters.this.okButtonActionPerformed(evt);
            }
            else if (evt.getSource() == cancelButton) {
                FrequencyReportParameters.this.cancelButtonActionPerformed(evt);
            }
            else if (evt.getSource() == helpButton) {
                FrequencyReportParameters.this.helpButtonActionPerformed(evt);
            }
        }
    }                       
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {                                         
        vAllReports = new JTextField(c4Utilities.CIFORProperties.fParameterAll);
        vTodaysReports = new JTextField(c4Utilities.CIFORProperties.fParameterToday);
        if (ckboxAllReports.isSelected()) 
            {
		...
		/*
		 *  Call the Frequency Report program
		 */
		if (c4Utilities.DateValidator.invalidDate != "Y")
		{
		    try {
		    	FrequencyReport.main(null);
			} catch (Exception e) {
				e.printStackTrace();
			}
		    dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
            	FrequencyReportParameters frame = new FrequencyReportParameters();
