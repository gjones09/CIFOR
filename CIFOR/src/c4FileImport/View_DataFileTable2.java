...
public class View_DataFileTable2 extends JFrame {
	...
	public View_DataFileTable2(String dataFilePath) {
		...
		for (int i = 0; i < 28; i++) 
		{
			...
			else if (i == 8)  {column.setPreferredWidth(120);}		// Primary Enzyme Pattern
			else if (i == 9)  {column.setPreferredWidth(120);}		// Secondary Enzyme Pattern
	...
	private class FormListener implements java.awt.event.ActionListener {
		...
		public void actionPerformed(java.awt.event.ActionEvent evt) {
			if (evt.getSource() == closeButton) {
				View_DataFileTable2.this.closeButtonActionPerformed(evt);
			}
		}
	}
	...
	public static void main(String s[]) {
		...
		View_DataFileTable2 frame = new View_DataFileTable2(null);
