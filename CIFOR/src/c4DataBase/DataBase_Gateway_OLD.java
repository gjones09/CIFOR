...
public class DataBase_Gateway_OLD
{
 ...
 */
	public static void main(String[] arguments) throws SQLException
	{
		...
		PrimaryEnzymePattern	= FileImport_FileModelUpdateRpt.field9;		// Primary Enzyme Pattern
		SecondaryEnzymePattern	= FileImport_FileModelUpdateRpt.field10;	// Secondary Enzyme Pattern
		OtherResult				= FileImport_FileModelUpdateRpt.field11;	// Other Result
//		DemographicsID			= C4FileImport_FileModelUpdateRpt.field12;	// Secondary Enzyme Pattern
//		EPICaseID				= C4FileImport_FileModelUpdateRpt.field11;	// Other Result
	...
	public static void UpdateResultsRecord() throws SQLException
	{
		...
		sql2 = 	"UPDATE CIFOR_LAB_RESULT 	set " +				// Update the Results record
				...
				"DATE_REPORTED				= ?, " +
		   		"PRIMARY_TEST 				= ?, " +
		   		"ORGANISM 					= ?, " +
		   		"PRIMARY_ENZYME_PATTERN 	= ?, " +
		   		"SECONDARY_ENZYME_PATTERN 	= ?, " +
		   		"OTHER_RESULT 				= ?, " +
		   		"EPI_CASE_ID				= ?, " +
		   		"PATIENT_ID					= ? " +
			...
			PreparedStatement 	pStmt2 = DBUpdate.connection.prepareStatement(sql2);
				...
				pStmt2.setString	(8, PrimaryEnzymePattern);
				pStmt2.setString	(9, SecondaryEnzymePattern);
 ...
 */
	public static void AddResultsRecord() throws SQLException
	{
		...
		PreparedStatement 	pStmt4 = DBUpdate.connection.prepareStatement(sql4);
			...
			pStmt4.setString	(9, PrimaryEnzymePattern);
			pStmt4.setString	(10, SecondaryEnzymePattern);
	...
	static String			PrimaryEnzymePattern;
	static String			SecondaryEnzymePattern;
