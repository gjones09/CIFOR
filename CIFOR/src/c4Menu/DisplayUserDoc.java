...
/*
 * This program will display a PDF of the CIFOR Users Guide
 */
public class DisplayUserDoc extends javax.swing.JDialog {
	/**
	 * 
	 */
		        ...
		        try                                      //try statement
		        {
		        ...
		        } catch (Exception e)                    //catch any exceptions here
		          {
					  JOptionPane.showMessageDialog(controllingFrame,
							...
							"to make sure the file CIFOR2_User_Guide.pdf is present.\n" +
							" " +
							"Thank You");
		          }
		    }
	 ...
	 * Program Variables
	 */
      private static String documentation	=	c4Utilities.CIFORProperties.cifor_UserDoc;
