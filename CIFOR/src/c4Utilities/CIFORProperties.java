...
public class CIFORProperties
{
     ...
     */
  	public static void getProperties()
  	{
		...
		//aboutVersion 				= messages.getString("Version");
		...
		vCDCPriEnzymeErrorMsg		= messages.getString("editCDCPriEnzymeErrorMsg");
		vCDCSecEnzymeErrorMsg		= messages.getString("editCDCSecEnzymeErrorMsg");
		vLocalPriEnzymeErrorMsg		= messages.getString("editLocalPriEnzymeErrorMsg");
		vLocalSecEnzymeErrorMsg		= messages.getString("editLocalSecEnzymeErrorMsg");
		...
		vCDCClusterCodeErrorMsg		= messages.getString("editCDCClusterCodeErrorMsg");
		vRegionErrorMsg				= messages.getString("editRegionErrorMsg");
		 ...
		 */
		dyCalendarIcon				= messages.getString("CalendarImage");
		...
		//crReportHeadingRegion		= messages.getString("crReportHeadingRegion");
		...
		//crReportTodaysReportsRegion = messages.getString("crReportTodaysReportsRegion");
		crReportAllReports			= messages.getString("crReportAllReports");
		//crReportAllReportsRegion	= messages.getString("crReportAllReportsRegion");
		...
		crReportRegion				= messages.getString("crReportRegion");
		...
		crReportClusterCode			= messages.getString("crReportClusterCode");
		...
		crReportExcelSheet1Region	= messages.getString("crReportExcelSheet1Region");
	...
	public static String vCDCPriEnzymeErrorMsg;
	public static String vCDCSecEnzymeErrorMsg;
	public static String vLocalPriEnzymeErrorMsg;
	public static String vLocalSecEnzymeErrorMsg;
	...
	public static String vCDCClusterCodeErrorMsg;
	public static String vRegionErrorMsg;
	 ...
	 */
	public static String dyCalendarIcon;
	...
	//public static String crReportHeadingRegion;
	...
	//public static String crReportTodaysReportsRegion;
	public static String crReportAllReports;
	//public static String crReportAllReportsRegion;
	...
	public static String crReportRegion;
	...
	public static String crReportClusterCode;
	...
	public static String crReportExcelSheet1Region;
