...
public class Parameters extends javax.swing.JDialog {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == okButton) {
                Parameters.this.okButtonActionPerformed(evt);
            }
            else if (evt.getSource() == cancelButton) {
                Parameters.this.cancelButtonActionPerformed(evt);
            }
            else if (evt.getSource() == helpButton) {
                Parameters.this.helpButtonActionPerformed(evt);
            }
        }
    }                       
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) { 
		...
		//System.out.println("DCParam 271, stringCurrentDate=" + stringCurrentDate);
...
/////////////////////////////////////////////////////////
	        	//ClusterMain.main(null);
	        	//DynamicClusterMainX.main(null);
	        	//ClusterReportNewFormat.main(null);
